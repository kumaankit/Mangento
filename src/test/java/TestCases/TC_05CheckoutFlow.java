...
public class TC_05CheckoutFlow extends BaseClass {
	@Test(dataProvider = "Checkoutdata", dataProviderClass = DataProviders.class)
    public void checkoutFlowTest(String eid, String pass, String productName, String str, String citi, String zip, String phone, String expectedResult ) throws InterruptedException {
		        ...
		        if (!productList.isEmpty()) {
		          ...
		          Thread.sleep(2000);
			        ...
			        if (ck.isShippingAddressPresent()) {
			            ...
			            Thread.sleep(2000); // Again, prefer WebDriverWait
			            ck.Next();
